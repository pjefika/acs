...
public class LoginBean implements Serializable{
	...
	public void validaAdm() {
		...
		try {
			...
			if (this.logado) {
				...
				if (!this.servicoLogin.listarUsuarioEfikaEspecifico(this.usuario).getAdm()) {

					context.redirect("/Acs/restrito.jsf");
	...
	public void validaAtivo() {
		...
		try {
			...
			if (this.logado) {
				...
				if (!this.servicoLogin.listarUsuarioEfikaEspecifico(this.usuario).getAtivo()) {
	...
	public Boolean listarStatusUser(String status) {
		
		try {
			
			Boolean result;
			
			if (status.equalsIgnoreCase("Adm")) {
				
				result = this.servicoLogin.listarUsuarioEfikaEspecifico(this.usuario).getAdm();
				
			} else {
				
				result = this.servicoLogin.listarUsuarioEfikaEspecifico(this.usuario).getAtivo();
