...
public class DevicesActionsServico {
	...
	public GatewayInfoHolder getGatewayInfoHolder(Integer deviceId) throws Exception {
		...
		String url = "http://10.200.6.150/nbbs/api/capability/diagnostic?diagnostic=" + URLEncoder.encode("\"getGatewayInfo\"", "UTF-8") + "&deviceId=" + deviceId;		
		...
		GatewayInfoHolder gatewayInfoHolder = gson.fromJson(output, GatewayInfoHolder.class);
	...
	public PortMappingTableHolder getPortMappingTable(Integer deviceId) throws Exception {

		Client client = Client.create();
		
		String url = "http://10.200.6.150/nbbs/api/capability/diagnostic?diagnostic=" + URLEncoder.encode("\"getPortMappingTable\"", "UTF-8") + "&deviceId=" + deviceId;	
	...
	public LanEthernetInfoHolder getLanEthernetInfo(Integer deviceId) throws Exception {
